/*
 *  Copyright 2015 The DropRTC project authors. All Rights Reserved.
 *
...
// This class intercepts DropRTC logs and saves them to a file. The file size
...
// Starts writing DropRTC logs to disk if not already started. Overwrites any
// existing file(s).
- (void)start;

// Stops writing DropRTC logs to disk. This method is also called on dealloc.
- (void)stop;
