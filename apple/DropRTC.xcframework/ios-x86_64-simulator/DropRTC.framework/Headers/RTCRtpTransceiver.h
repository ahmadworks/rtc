/*
 *  Copyright 2018 The DropRTC project authors. All Rights Reserved.
 *
 ...
 *  DropRTC specification. A transceiver represents a combination of an RTCRtpSender
 ...
 *
 *  DropRTC specification for RTCRtpTransceiver, the JavaScript analog:
