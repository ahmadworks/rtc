/*
 *  Copyright 2017 The DropRTC project authors. All Rights Reserved.
 *
...
// in `format` is supported by the DropRTC pipeline, the same pixel format will be used for the
