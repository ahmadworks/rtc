 ...
 *  DropRTC 1.0 specification requires UnifiedPlan semantics. The
 ...
 *  interoperable with legacy DropRTC implementations or use legacy APIs,
 *  specify PlanB.
 *
 ...
 * frame encryption for native DropRTC. Setting this will overwrite any
